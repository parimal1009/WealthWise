              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">Get personalized pension optimization strategies</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-1">Risk Protection</h3>
                    <p className="text-slate-600 text-sm">Monte Carlo simulations for market uncertainty</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">Compare multiple payout scenarios instantly</p>
                  </div>
                </div>
              </div>
            </div>
