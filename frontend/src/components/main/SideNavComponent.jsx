    ...
    <div className="bg-white overflow-hidden">
      ...
      <nav className="p-6">
        ...
        <button
          ...
          className="mt-4 w-full border border-2 border-red-500 hover:bg-red-500 text-red-500 hover:text-white cursor-pointer px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md"
        >
          Logout
        </button>
      </nav>
